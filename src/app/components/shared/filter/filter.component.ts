...
export class FilterComponent implements OnInit {
  ...
  filtros = {
    ...
    comunasPorRegion: {
      ...
      'Aysén': ['Coyhaique','Puerto Aysén','Chile Chico','Cisnes','Guaitecas','Lago Verde','Coihaique','O’Higgins','Río Ibáñez','Tortel'],
  ...
  toggleDeporte(deporte: string): void {
    const index = this.selectedDeportes.indexOf(deporte);
    if (index > -1) {
      this.selectedDeportes.splice(index, 1);
    } else {
      this.selectedDeportes.push(deporte);
    }
  }
